...
export const InfoCards = ({ centerInfo }: InfoCardsProps) => {
  return (
    <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
      {/* Horaires */}
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1 group h-full min-h-55 flex flex-col justify-between">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1 group h-full min-h-55 flex flex-col justify-between">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 italic mt-auto">
